...
=======
        ...
        bitpack_write(&server.bp, 8,  (uint32_t)c->phys.hp);
>>>>>>> Stashed changes
...
=======
        ...
        bitpack_write(&server.bp, 9,  (uint32_t)(d->rotation));
