...
uint32_t ambient_light_default = 0x00B0B0B0;
uint32_t ambient_light = 0x00B0B0B0;
...
void lighting_point_light_clear_all()
{
    list_clear(lighting_list);
}
