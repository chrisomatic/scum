...
#define MONSTER_ROOM_PERCENTAGE 90
...
typedef enum
{
    ...
    SPRITE_TILE_DOOR,
    SPRITE_TILE_DOOR_BOSS,
    SPRITE_TILE_DOOR_TREASURE,
    SPRITE_TILE_DOOR_SHRINE,
    SPRITE_TILE_PIT,
    SPRITE_TILE_MUD,
    SPRITE_TILE_ICE,
    SPRITE_TILE_SPIKES,
    SPRITE_TILE_SPIKES_DOWN,
    SPRITE_TILE_DOOR_CLOSED,
    SPRITE_TILE_DOOR_BOSS_CLOSED,
    SPRITE_TILE_DOOR_TREASURE_CLOSED,
    SPRITE_TILE_DOOR_SHRINE_CLOSED,
